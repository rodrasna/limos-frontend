...
import { createProfessional } from "../graphql/mutations";
export default function ProfessionalCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createProfessional.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ProfessionalCreateForm")}
      {...rest}
    >
      <TextField
        label="First name"
